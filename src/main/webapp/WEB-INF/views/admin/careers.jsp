...
<head>
    ...
    <title>Career Management - Admin</title>
        ...
        <div class="admin-content">
            ...
            <div class="admin-card">
                ...
                <div class="admin-card-body">
                    <form action="/api/admin/create-career" method="post" class="admin-form">
                        <div class="admin-form-row">
                            <div class="admin-form-group">
                                <label>Career Name</label>
                                <input type="text" name="careerName" required placeholder="e.g., Software Developer">
                            </div>
                            <div class="admin-form-group">
                                <label>Required Skills</label>
                                <input type="text" name="requiredSkills" required placeholder="e.g., Java, SQL, Spring">
                            </div>
                        </div>
                        <div class="admin-form-row">
                            <div class="admin-form-group">
                                <label>Qualification</label>
                                <input type="text" name="qualification" required placeholder="e.g., B.Tech/B.E. in Computer Science">
                            </div>
                        ...
                        <div class="admin-form-group">
                            ...
                            <textarea name="description" rows="3" placeholder="Enter career description..."></textarea>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="admin-table-container">
                <div class="admin-table-header">
                    <h3><i class="fas fa-list"></i> All Careers</h3>
