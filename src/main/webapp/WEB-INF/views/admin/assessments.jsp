		...
		<aside class="admin-sidebar" id="sidebar">
			...
			<nav class="admin-sidebar-nav">
				<ul>
					...
					<li><a href="/admin/assessments" class="active"><i
			...
			<div class="admin-content">
						...
						<div class="admin-form-row">
							<div class="admin-form-group">
								<label for="testName">Test Name</label> <input type="text"
									...
									placeholder="e.g., Java Programming Assessment" required>
							</div>
							<div class="admin-form-group">
						...
						<div class="admin-form-row">
							<div class="admin-form-group">
								<label for="totalMarks">Total Marks</label> <input type="number"
									id="totalMarks" name="totalMarks" min="1"
				...
				<div class="admin-table-container">
					<div class="admin-table-header">
						<h3>
							<i class="fas fa-clipboard-list"></i> Existing Assessments
						</h3>
