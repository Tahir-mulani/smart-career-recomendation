        ...
        <div class="admin-content">
            ...
            <div class="admin-card">
                ...
                <div class="admin-card-body">
                    <form action="/api/admin/create-assessment" method="post" class="admin-form">
                        <div class="admin-form-row">
                            <div class="admin-form-group">
                                <label>Test Name</label>
                                <input type="text" name="testName" required placeholder="e.g., Java Programming Test">
                            </div>
                            <div class="admin-form-group">
                            ...
                            <div class="admin-form-group">
                                ...
                                <input type="number" name="totalMarks" required placeholder="e.g., 100">
                            </div>
            ...
            <div class="admin-table-container">
                ...
                <table class="admin-table">
                    ...
                    <tbody>
                        ...
                        <% java.util.Map<Long, Integer> questionCounts = (java.util.Map<Long, Integer>) request.getAttribute("questionCounts"); %>
                        <% if (assessments != null && !assessments.isEmpty()) { %>
                            <% for (Assessment assessment : assessments) { %>
                                <tr>
                                    ...
                                    <td><%= questionCounts != null ? questionCounts.getOrDefault(assessment.getId(), 0) : 0 %></td>
