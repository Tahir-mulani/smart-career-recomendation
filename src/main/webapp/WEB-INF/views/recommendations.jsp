...
<body class="admin-body">
		...
		<aside class="admin-sidebar" id="sidebar">
			...
			<nav class="admin-sidebar-nav">
				<ul>
					...
					<li><a href="/recommendations" class="active"><i
		...
		<main class="admin-main">
			...
			<div class="admin-content">
				...
				<div class="admin-form">
					<h3>
						<i class="fas fa-info-circle"></i> Your Career Recommendations
					</h3>
					<p>Based on your assessment results, skills, and interests,
						here are the recommended career paths for you.</p>
					<div class="admin-form-actions">
						<a href="/api/generate-recommendations"
							class="admin-btn admin-btn-primary"> <i class="fas fa-sync"></i>
							Generate New Recommendations
						</a> <a href="/dashboard" class="admin-btn admin-btn-secondary"> <i
				...
				<div class="admin-table-container">
					<div class="admin-table-header">
						<h3>
							<i class="fas fa-star"></i> Recommended Careers
						</h3>
					</div>
					<%
 ...
 %>
								...
								<td><a href="/dashboard"
									...
									style="padding: 6px 15px; font-size: 0.85rem;">View Details</a>
								</td>
							</tr>
							<%
							}
					...
					<div class="empty-state">
						...
						<p>Complete assessments to get personalized career
							recommendations based on your skills and performance.</p>
						<div
							style="margin-top: 25px; display: flex; justify-content: center; gap: 15px; flex-wrap: wrap;">
							<a href="/dashboard" class="admin-btn admin-btn-primary">Take
								Assessments</a> <a href="/api/generate-recommendations"
								class="admin-btn admin-btn-secondary">Generate
								Recommendations</a>
						</div>
					</div>
					<%
